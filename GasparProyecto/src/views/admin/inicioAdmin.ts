...
export function inicioAdmin(){
  ...
  <div class="w-screen h-screen bg-black flex">
    ...
    <aside class=" bg-black text-white p-6 flex flex-col gap-4">
      ...
      <button id="crearCliente" class="text-left hover:bg-gray-800 p-2 rounded">
        Crear cliente
      </button>

      <button id="verClientes" class="text-left hover:bg-gray-800 p-2 rounded">
        Ver clientes
      </button>
      ...
      <button id="crearClase" class="text-left hover:bg-gray-800 p-2 rounded">
        Crear clase
      </button>

      <button id="eliminarClase" class="text-left hover:bg-gray-800 p-2 rounded">
        Eliminar clase
      </button>
